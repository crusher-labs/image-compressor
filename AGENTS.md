...
Single-purpose static tool: Compress images and reduce file size without uploading them to a server. Part of the crusher-labs **static tools line** (frozen). Hosted on GitHub Pages at https://crusher-labs.github.io/image-compressor/
